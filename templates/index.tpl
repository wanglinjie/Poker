                    ...
                    <td>
                      <table width="100%" border=0 align="center" cellpadding=0 cellspacing=1 class="table-border">
                        <tbody>
                          ...
                          <tr>
                            <td width="10%" height=30 class="table-body" align="center"><strong>报修编号</strong></td>
                            <td width="14%" height=30 class="table-body" align="center"><strong>部门或班级</strong></td>
                            <td width="13%" height=30 class="table-body" align="center"><strong>故障地点</strong></td>
                            <td width="13%" height=30 class="table-body" align="center"><strong>报修原因</strong></td>
                            <td width="10%" height=30 class="table-body" align="center"><strong>报修物品</strong></td>
                            <td width="10%" height=30 class="table-body" align="center"><strong>报修时间</strong></td>
                            <td width="6%" height=30 class="table-body" align="center"><strong>维修状态</strong></td>
                            <td width="8%" height=30 class="table-body" align="center"><strong>维修时间</strong></td>
                            <td width="16%" height=30 class="table-body" align="center"><strong>安排与反馈</strong></td>
                          </tr>
                        </tbody>
                      </table>
                    </td>
